...
using WeifenLuo.WinFormsUI.Docking.Extensions;
...
namespace WeifenLuo.WinFormsUI.Docking
{
    internal class VS2005DockPaneStrip : DockPaneStripBase
    {
        ...
        private const int _ToolWindowImageHeight = 18;
        private const int _ToolWindowImageWidth = 18;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (Appearance == DockPane.AppearanceStyle.Document)
            {
                ...
                if (rect.Width > 0 && rect.Height > 0)
                {
                    ...
                    {
                        e.Graphics.DrawLine(pen, 0, 1, rect.Width, 1);
                    }
        ...
        private GraphicsPath GetTabOutline(Tab tab, bool rtlTransform, bool toScreen)
        {
            if (Appearance == DockPane.AppearanceStyle.ToolWindow)
                ...
                return GetTabOutline_ToolWindow(tab, rtlTransform, toScreen, true);
        }

        private GraphicsPath GetTabOutline_ToolWindow(Tab tab, bool rtlTransform, bool toScreen, bool full = false)
        {
