...
namespace ScintillaNET
{
    public partial class Scintilla
    {
        ...
        void INativeScintilla.Colourise(int start, int end)
        {
            ...
            //ScintillaNET.Internal.UnsafeNativeMethods.SendMessage(new System.Runtime.InteropServices.HandleRef(this, Handle), ScintillaNET.Internal.NativeMethods.CO, IntPtr.Zero, IntPtr.Zero);
        ...
        void INativeScintilla.SetHighlightFold(bool highlightFold)
        {
            _ns.SendMessageDirect(2293, highlightFold);
        }
